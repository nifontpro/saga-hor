...
class ReverseProducerConfig(
	...
	@Bean("reverseKafkaTemplate")
	fun reverseKafkaTemplate(
		@Qualifier("reverse-producer-factory") producerFactory: ProducerFactory<String, OrderEvent>
	): KafkaTemplate<String, OrderEvent> {
		return KafkaTemplate(producerFactory)
	}

	@Bean("new-reverse-producer-topic")
